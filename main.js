      ...
      <div className="app">
        <div className="content">
          ...
          <ColumnComponent
            ...
            visibilty = {this.state.columnVisibility}
          />
          <BaseLineComponent
            baseLineHeight = {+this.state.baseLineHeight}
        ...
        <Controler valueLink={this.linkState('columnWidth')} valueLink2={this.linkState('columnVisibility')} state={this.state} name={this.state.columnWidth}/>
...
var ColumnComponent = React.createClass({
  ...
  render : function(){
    ...
    var visibility = this.props.visibilty;
    return(
      <svg  style={style.base}>
        <defs>
          <pattern id="Pattern" x={fix} y="0" width={colpat} height={rows} patternUnits="userSpaceOnUse" >
            <rect  x="0" y="0" width={colwidth1} height="100%" fill={color} fillOpacity="0.3" stroke={color} strokeOpacity="0" />
        ...
        <rect  x={wrappos} y="0" width={wrapper} height="100%" fill="url(#Pattern)" strokeWidth="0" stroke="black" opacity={visibility}></rect>
      </svg>
      )
  }
});
ColumnComponent = Radium(ColumnComponent);
